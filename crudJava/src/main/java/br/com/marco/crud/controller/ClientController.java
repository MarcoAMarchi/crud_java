...
public class ClientController {
	@Autowired //* Priorizar autowired no construtor
	...
	public ResponseEntity<?> remove(@PathVariable long id){
		...
		return ResponseEntity.ok().build(); //* No lugar de voltar um ok("") você pode voltar um ok().build(), o primeiro vai com um body vazio, o segundo vai sem um body(corrigido)
	}
